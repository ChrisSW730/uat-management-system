...
namespace UATSystem.API.Migrations
{
    ...
    [Migration("20260710044715_AddTestCaseDefectLinks")]
    partial class AddTestCaseDefectLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UATSystem.API.Models.TestCaseDefect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DefectId", "TestCaseId")
                        .IsUnique();

                    b.ToTable("TestCaseDefects");
                });
            ...
            modelBuilder.Entity("UATSystem.API.Models.UserAccount", b =>
                {
                    ...
                    b.Property<string>("ClickUpApiTokenEncrypted")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("ClickUpIntegrationEnabled")
                        .HasColumnType("bit");

                    b.Property<string>("ClickUpMappingsJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ClickUpSpaceId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ClickUpSpaceName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ClickUpValidationStatus")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ClickUpWorkspaceName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("UATSystem.API.Models.TestCaseDefect", b =>
                {
                    b.HasOne("UATSystem.API.Models.Defect", "Defect")
                        .WithMany("TestCaseDefects")
                        .HasForeignKey("DefectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UATSystem.API.Models.TestCase", "TestCase")
                        .WithMany("DefectLinks")
                        .HasForeignKey("TestCaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
